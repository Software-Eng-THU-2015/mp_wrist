...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='friend',
            name='members',
            field=models.ManyToManyField(related_name='user_friend_members', to='basic.User'),
        ),
        migrations.AddField(
            model_name='friend',
            name='owner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_friend_owner', to='basic.User'),
        ),
        migrations.AddField(
            model_name='daydata',
            name='user',
